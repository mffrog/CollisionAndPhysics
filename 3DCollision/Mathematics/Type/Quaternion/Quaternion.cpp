...
namespace myTools{
        ...
        Matrix4x4 QuatToMat(const Quaternion& q){
            ...
            retval[3][2] = 0;
            retval[3][3] = 1;
//            retval[0][0] = 1 - 2 * ( q.v.y * q.v.y + q.v.z * q.v.z);
//            retval[0][1] = 2 * ( q.v.x * q.v.y + q.w * q.v.z);
//            retval[0][2] = 2 * ( q.v.x * q.v.z - q.w * q.v.y);
//            retval[0][3] = 0;
//
//            retval[1][0] = 2 * ( q.v.x * q.v.y - q.w * q.v.z);
//            retval[1][1] = 1 - 2 * ( q.v.x * q.v.x + q.v.z * q.v.z);
//            retval[1][2] = 2 * ( q.v.y * q.v.z + q.w * q.v.x);
//            retval[1][3] = 0;
//
//            retval[2][0] = 2 * ( q.v.x * q.v.z + q.w * q.v.y);
//            retval[2][1] = 2 * ( q.v.y * q.v.z - q.w * q.v.x);
//            retval[2][2] = 1 - 2 * ( q.v.x * q.v.x + q.v.y * q.v.y);
//            retval[2][3] = 0;
//
//            retval[3][0] = 0;
//            retval[3][1] = 0;
